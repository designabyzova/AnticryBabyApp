    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                We take your privacy seriously. This app is designed with children's safety in mind.

                AI & Audio Processing:
                All cry detection and AI analysis is performed entirely on your device using Apple's CoreML framework. No audio data is ever recorded, stored, or transmitted to any external server. The app does NOT use any third-party AI service.

                Data Stored Locally:
                • Baby's name and birth date (for personalization)
                • Selected language preferences
                • Listening history and effectiveness ratings

                Audio Content:
                Soothing sounds are streamed from Cloudflare CDN. Streaming is not tracked or linked to user identity.
                ...
                • Apple StoreKit: For subscription management (managed entirely by Apple)
                • Cloudflare R2 CDN: For streaming audio content (anonymous, no tracking)

                Children's Privacy:
                This app is designed for parents to use with their children. We do not knowingly collect personal information from children. All baby-related data is stored locally on the parent's device.
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                1. Use of Service
                This app is designed to help calm babies. It is not a substitute for proper child care and supervision.

                2. Safety Notice
                Never let this app distract you from safe driving. Always keep your eyes on the road.

                3. Audio Safety
                The app limits maximum volume to protect your baby's hearing. Do not attempt to bypass these safety measures.

                4. Subscriptions
                Premium features require a subscription. Payment will be charged to your Apple ID account. Subscriptions automatically renew unless canceled at least 24 hours before the end of the current period. You can manage or cancel subscriptions in your App Store account settings.

                5. AI Processing
                All cry detection is performed on-device using Apple's CoreML. No audio is transmitted externally. The app does not use any third-party AI service.

                6. Content
                Audio content is streamed from our CDN or generated on-device. We do not guarantee the effectiveness of any specific sound for calming your baby.
